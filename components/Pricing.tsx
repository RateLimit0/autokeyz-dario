  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        <Image
          src="https://images.autokeyz.co.uk/images/parallax.jpeg"
      ...
      <div className="relative p-8 my-10 mx-4 rounded-lg">
        ...
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          {pricingDetails.map((pricing) => (
            <div 
              key={pricing.title} 
              className="p-6 bg-gray-800 bg-opacity-60 rounded-lg shadow-xl transform transition-transform duration-300 hover:scale-105"
            >
